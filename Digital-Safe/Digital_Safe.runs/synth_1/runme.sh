...
HD_PWD='C:/Users/Asus/Desktop/Digital_Safe/Digital_Safe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_Safe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_Safe.tcl