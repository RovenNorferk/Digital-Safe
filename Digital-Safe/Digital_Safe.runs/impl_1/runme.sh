...
HD_PWD='C:/Users/Asus/Desktop/Digital_Safe/Digital_Safe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_Safe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_Safe.tcl -notrace
